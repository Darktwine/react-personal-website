    ...
    return (
        <footer style={{backgroundColor: '#101909', color: 'white', paddingTop: '40px', paddingBottom:'40px'}}>
            <div style={{color: 'gray', display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '500px', marginLeft: 'auto', marginRight: 'auto' }}>
                ...
                <a href="mailto:Kevin.FNCW@gmail.com" rel='noreferrer' style={{color: "inherit"}}><FontAwesomeIcon icon={faEnvelope} size="2x" /></a>
                <a href="https://www.github.com/Darktwine" rel='noreferrer' target="_blank" style={{color: "inherit"}}><FontAwesomeIcon icon={faGithub} size="2x" /></a>
                <a href="https://www.linkedin.com/in/kfncw/" style={{color: "inherit"}}><FontAwesomeIcon icon={faLinkedin} size="2x" /></a>
                <a href={Resume} download="KW_Resume_2021.pdf" style={{color: "inherit"}}><FontAwesomeIcon icon={faFile} size="2x" /></a>
            </div>
